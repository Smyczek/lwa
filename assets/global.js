...
document.querySelectorAll('.footer-block.grid__item').forEach((footermenu) => {
  let title = footermenu.querySelector('.expand-menu-btn');
  if (title) {
...
//   $(".footer-block--menu h2).click(function(e) {
//     $("h2").removeClass("active");
//     $(".footer-block--menu ul").slideUp();
...
const searchbar = document.getElementById('heder-search-form');
...
class HeaderDrawer extends MenuDrawer {
  ...
  openMenuDrawer(summaryElement) {
    this.header = this.header || document.querySelector('.header__heading');
...
class AccessoryVariantSelects extends HTMLElement {
  constructor() {
    super();
  ...
  addSup(price) {
    ...
    return j[0] +"<sup>" +  j[1] + "</sup>";
  }

  updatePrice() {
    const formid = document.getElementById(this.dataset.accessory);
    let price = formid.getElementsByClassName('price-item')[0];
    let select = this.getElementsByClassName('product-variants')[0].selectedOptions[0].getAttribute('variant-price');

    price.innerHTML = this.addSup(select);
  };
}

customElements.define('accessory-variant-selects', AccessoryVariantSelects);
...
function responsiveVideos() {
  var frames = document.querySelectorAll('iframe[src*="youtube.com/embed"], iframe[src*="player.vimeo"]' );
  frames.forEach(element => wrap(element, document.createElement('div')))
};
responsiveVideos();

// https://web.dev/browser-level-image-lazy-loading/
// setTimeout(function() {
//   document.querySelector(`script[src*='search-magic']`).remove();
//   document.querySelector(`link[href*='search-magic']`).remove();
// },6000)();
  ...
  mutations.forEach(({ addedNodes }) => {
      addedNodes.forEach(node => {
         ...
         // See above for script tag checks…
          ...
          if (node.id == 'ysw-search-magic-script-sec') {
